...
import com.example.newsapp.model.ListImage
...
private val news = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit  esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum"
    ...
    private val listData = mutableListOf(
        ...
        News("BBM naik woy, laka duit", bbm,"Faizal","13 September 2023", mutableListOf(ListImage(R.drawable.demo_bbm_naik),ListImage(R.drawable.tolak_bbm_naik),ListImage(R.drawable.bbm))),
        News("Lorem", news,"Faizal","13 September 2024", mutableListOf(ListImage(R.drawable.danilla))),
        News("Lorem", bjorka,"Faizal","13 September 2025", mutableListOf(ListImage(R.drawable.danilla))),
        News("Lorem", bbm,"Faizal","13 September 2026", mutableListOf(ListImage(R.drawable.danilla))),
        News("Lorem", news,"Faizal","13 September 2027", mutableListOf(ListImage(R.drawable.danilla))),
        News("Lorem", bjorka,"Faizal","13 September 2028", mutableListOf(ListImage(R.drawable.danilla))),
        News("Lorem", bbm,"Faizal","13 September 2029", mutableListOf(ListImage(R.drawable.danilla))),
        News("Lorem", news,"Faizal","13 September 2030", mutableListOf(ListImage(R.drawable.danilla))),
        News("Lorem", bjorka,"Faizal","13 September 2031", mutableListOf(ListImage(R.drawable.danilla))),
        News("Lorem", bbm,"Faizal","13 September 2032", mutableListOf(ListImage(R.drawable.danilla))),
        News("Lorem", news,"Faizal","13 September 2033", mutableListOf(ListImage(R.drawable.danilla))),
        News("Lorem", bjorka,"Faizal","13 September 2034", mutableListOf(ListImage(R.drawable.danilla))),
    )
